...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@learn88.top',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/.password/wta-2989-ta'],
